...
description: Generate a bitmap image with the `generate_image` tool and save it as a file. Use when the user asks Jori to produce an illustration, mockup, icon, texture, background, social image, or other generated picture.
category: creation
---
