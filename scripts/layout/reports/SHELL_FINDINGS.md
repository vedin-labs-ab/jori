...
Authoritative profile ledgers and all occurrences: [main review](dist/layout-hunt/before/shell/reviewed.json), [V2 review](dist/layout-hunt/SHELL_V2_REVIEW.json), [all shell causes](dist/layout-hunt/SHELL_CAUSES.json), [closeout data](dist/layout-hunt/SHELL_CLOSEOUT.json). The previous detailed report is preserved as [historical findings](dist/layout-hunt/SHELL_FINDINGS_PRE_CLOSEOUT.md).
...
Sources: [styles.css](src/styles.css), [__root.tsx](src/routes/__root.tsx).

Strongest record: [shell-route-home-enter/cold-375](dist/layout-hunt/before/shell/shell-route-home-enter/cold-375/record.json); [250.png](dist/layout-hunt/before/shell/shell-route-home-enter/cold-375/250.png), [1000.png](dist/layout-hunt/before/shell/shell-route-home-enter/cold-375/1000.png).
...
Sources: [group.tsx](src/shared/console/shell/group.tsx).

Strongest record: [shell-route-home-enter/warm-1440](dist/layout-hunt/before/shell/shell-route-home-enter/warm-1440/record.json); [0.png](dist/layout-hunt/before/shell/shell-route-home-enter/warm-1440/0.png), [250.png](dist/layout-hunt/before/shell/shell-route-home-enter/warm-1440/250.png).
...
Sources: [home.tsx](src/shared/console/chat/home.tsx).

Strongest record: [shell-protected-02-enter/warm-1440](dist/layout-hunt/before/shell/shell-protected-02-enter/warm-1440/record.json); [3000.png](dist/layout-hunt/before/shell/shell-protected-02-enter/warm-1440/3000.png), [settled.png](dist/layout-hunt/before/shell/shell-protected-02-enter/warm-1440/settled.png).
...
Sources: [footer.tsx](src/shared/console/chat/composer/footer.tsx).

Strongest record: [shell-nested-missing-chat/warm-1440](dist/layout-hunt/before/shell/shell-nested-missing-chat/warm-1440/record.json); [250.png](dist/layout-hunt/before/shell/shell-nested-missing-chat/warm-1440/250.png), [1000.png](dist/layout-hunt/before/shell/shell-nested-missing-chat/warm-1440/1000.png).
...
Sources: [runs.tsx](src/landing/demo/pages/runs.tsx), [time.ts](src/shared/console/runs/time.ts).

Strongest record: [shell-route-pricing-back/cold-375](dist/layout-hunt/before/shell/shell-route-pricing-back/cold-375/record.json); [0.png](dist/layout-hunt/before/shell/shell-route-pricing-back/cold-375/0.png), [settled.png](dist/layout-hunt/before/shell/shell-route-pricing-back/cold-375/settled.png).
...
Sources: [lane.tsx](src/console/context/workstreams/activity/lane.tsx).

Strongest record: [C163-workstreams/warm-375](dist/layout-hunt/before/controls/C163-workstreams/warm-375/record.json); [250.png](dist/layout-hunt/before/controls/C163-workstreams/warm-375/250.png), [1000.png](dist/layout-hunt/before/controls/C163-workstreams/warm-375/1000.png).
...
Sources: [stats.tsx](src/shared/console/folders/usage/stats.tsx).

Strongest record: [shell-live-usage-30-to-7/warm-375](dist/layout-hunt/before/shell-resume/shell-live-usage-30-to-7/warm-375/record.json); [before.png](dist/layout-hunt/before/shell-resume/shell-live-usage-30-to-7/warm-375/before.png), [0.png](dist/layout-hunt/before/shell-resume/shell-live-usage-30-to-7/warm-375/0.png), [250.png](dist/layout-hunt/before/shell-resume/shell-live-usage-30-to-7/warm-375/250.png).
...
Sources: [index.tsx](src/console/integrations/card/index.tsx), [headline.ts](src/console/integrations/card/headline.ts).

Strongest record: [C156-personal/warm-375](dist/layout-hunt/before/controls/C156-personal/warm-375/record.json); [0.png](dist/layout-hunt/before/controls/C156-personal/warm-375/0.png), [250.png](dist/layout-hunt/before/controls/C156-personal/warm-375/250.png).
...
Sources: [form.tsx](src/landing/waitlist/form.tsx), [field.tsx](src/components/ui/field.tsx).

Strongest record: [shell-waitlist-email-error/cold-375](dist/layout-hunt/before/shell-resume/shell-waitlist-email-error/cold-375/record.json); [before.png](dist/layout-hunt/before/shell-resume/shell-waitlist-email-error/cold-375/before.png), [0.png](dist/layout-hunt/before/shell-resume/shell-waitlist-email-error/cold-375/0.png).
...
Sources: [provider-button.tsx](src/components/auth/provider-button.tsx), [button.tsx](src/components/ui/button.tsx).

Strongest record: [shell-auth-google-pending/cold-375](dist/layout-hunt/before/shell-resume/shell-auth-google-pending/cold-375/record.json); [before.png](dist/layout-hunt/before/shell-resume/shell-auth-google-pending/cold-375/before.png), [0.png](dist/layout-hunt/before/shell-resume/shell-auth-google-pending/cold-375/0.png).
...
Warm hash inventory: [17 IDs/34 warm slots](dist/layout-hunt/SHELL_WARM_HASH_REPEATS.json). The final manifests preserve reachable recipes; a prepared recipe is not a measured pass.
...
Proofs: [cache and real permission](dist/layout-hunt/controls-review-final/cache-preflight.json), [warm fragment](dist/layout-hunt/transport-integration-preflight.json). Full helper hashes are in the closeout JSON. All shell browsers are closed; no shared account reads or writes remain queued.
