...
/** The client-side contract summary: what each template's state holds, so
 *  the console can describe a not-yet-provisioned artifact without the
 *  server-only compiled template payload. */
