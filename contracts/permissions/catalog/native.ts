...
export const nativeToolPermissionRows = [
  ...
  [
    ...
    "Start a Milo agent run for a delegated task. Always give it a concise title that identifies the work. It works independently with your integration and web tool access unless tools narrows it. Grant the least access that covers the task — the agent can never hold access you lack.",
    "write",
    "required",
    "agent",
  ],
  [
    ...
    "Wait for 1-20 direct child agents without consuming compute. Resume when every listed run is terminal or the relative timeout is reached, whichever comes first.",
    "read",
    "required",
    "agent",
  ],
