...
export const nativeToolPermissionRows = [
  ...
  [
    ...
    "Start a Milo agent run for a delegated task; it works independently with your integration and web tool access unless tools narrows it. Grant the least access that covers the task — the agent can never hold access you lack.",
    "write",
    "required",
    "agent",
  ],
