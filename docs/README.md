...
Source documents for Milo's system design.

## Documents

- [Tech stack](./stack.md): the source of truth for Milo's core technical choices.
- [Platform](./platform/README.md): the top-level domain ownership map.
