    ...
    inputSchema: withOptionalFieldGuidance({
      ...
      properties: {
        ...
        tools: stringArrayProperty(
          "Tool names the agent may use, exact names from your own tools. Omit to pass on your full access. Grant the smallest set that covers the task; names outside your own access are dropped. Replying, finishing, and loading skills need no grant."
        ),
      },
    }),
    route: "agent",
