...
/**
 * Where an app came from, when a template produced it: the most
...
export function templateProvenance(
  ...
  currentVersionId: Id<"appVersions"> | undefined
) {
...
export function summarizeCapabilities(capabilities: Doc<"appTools">[]) {
