...
import { type AppTreeRecord, type NormalizedAppSourceFile } from "."

export function buildGitTreeSnapshot(files: NormalizedAppSourceFile[]) {
...
function buildTree(files: NormalizedAppSourceFile[]) {
...
function flattenTrees(tree: MutableTreeNode): AppTreeRecord[] {
  return [
    {
      id: tree.id,
...
type MutableTreeNode = {
  ...
  files: Map<string, NormalizedAppSourceFile>
}
