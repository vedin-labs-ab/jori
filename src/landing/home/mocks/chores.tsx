...
export function Chores() {
  ...
  return (
    <Section
      id="work"
      lede="Every company runs on chores: the weekly summary, the invoice chase, the ticket triage, the changelog. Write each one down once. Jori runs it on a schedule or when something happens, and files what it made where the team can find it."
      support
