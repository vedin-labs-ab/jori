...
test.each(["Leads", "Ada Lovelace"])(
  "a drag can start from %s, and releasing it does not open the row",
  (name) => {
    vi.useFakeTimers()
...
test.each(["Select Leads", "Sales", "Actions", "Note", "Portaled action"])(
  "a pointer move on %s does not drag the row",
  (name) => {
