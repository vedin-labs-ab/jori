  ...
  return (
    <span
      className={cn(
        ...
        // A span's text asks for the I-beam. As a tab it is a control, and
        // takes the arrow every button and tab in the product has.
        "[&[role=tab]]:cursor-default [&[role=tab]]:select-none",
