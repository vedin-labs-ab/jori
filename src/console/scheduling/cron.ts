...
const defaultParts: CronParts = {
  cron: emptyScheduleForm.cron,
  monthDay: emptyScheduleForm.monthDay,
  repeat: emptyScheduleForm.repeat,
  time: emptyScheduleForm.time,
  weekday: emptyScheduleForm.weekday,
}
