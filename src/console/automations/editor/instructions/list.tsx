...
export function ReadonlyAutomationSurfaceToolGroups({
  tools,
}: {
  tools: AutomationToolCapability[]
}) {
  return (
    <ToolGroupsFrame>
...
function ReadonlyToolGroup({
  ...
  group: ToolAccessGroup<AutomationToolCapability>
}) {
  return (
    <ToolGroupSection
      access={group.access}
...
function ReadonlyToolRow({ tool }: { tool: AutomationToolCapability }) {
  return (
