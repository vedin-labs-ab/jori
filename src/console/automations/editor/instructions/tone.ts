...
import { type getAutomationSurfaceAccess } from "../../surfaces"
...
export function getAutomationSurfaceToneClassNames(
  access: ReturnType<typeof getAutomationSurfaceAccess>,
  blocked: boolean
) {
  return blocked
...
const automationSurfaceToneClassNames = {
  ...
  ReturnType<typeof getAutomationSurfaceAccess> | "blocked",
  {
    scopeIcon: string
    separator: string
    surface: string
