  ...
  return (
    <div className="flex items-center gap-1.5 text-muted-foreground text-xs">
      ...
      {href === undefined ? (
        ...
        <a
          className="group/reveal inline-flex items-center rounded-sm transition-colors duration-200 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          href={href}
          rel="noreferrer"
          target="_blank"
        >
