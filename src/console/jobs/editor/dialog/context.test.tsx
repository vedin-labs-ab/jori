...
test("progressively discloses the context supplied to job runs", () => {
  render(<JobContextSection scope="personal" />)
...
test("omits requester context for organization jobs", () => {
  render(<JobContextSection scope="organization" />)
