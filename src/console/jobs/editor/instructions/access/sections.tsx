...
type JobSurfaceToolGroupsProps = {
...
export function JobSurfaceToolGroups({
  onToolsChange,
  permissions,
  organizationId,
  tools,
}: JobSurfaceToolGroupsProps) {
...
function getToolDescription(permission: ToolPermission) {
  ...
  return `${permission.description} ${jobToolModeDescription(permission)}`
}
