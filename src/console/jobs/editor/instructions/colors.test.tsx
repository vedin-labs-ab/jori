...
describe("job instructions marker colors", () => {
...
describe("job instructions blocked marker colors", () => {
  test("uses a blocked palette when policy denies job access", async () => {
    const field = renderInstructionsField({
      description: "Post to @GitHub.",
      permissions: [
        {
    ...
    expect(buttonGroup?.getAttribute("data-job-surface-policy")).toBe("blocked")
