...
While a request is pending, do other independent work or stop; the run pauses on its own until every request resolves. To withdraw a request you no longer need, call `cancel_approval_request` with its approval id and a reason.
