...
- Never rewrite history: journal entries are immutable records, and corrections are new entries.
- Never open an entry with a date or timestamp; the system attaches dates as metadata.
